...
public class DisponibilidadeTests {
    ...
    public void testCriarUmaDisponibilidade(){
        ...
        Assertions.assertNotNull(disponibilidade.idDisponibilidade);
        Assertions.assertTrue(disponibilidade.isPersistent());
        Assertions.assertEquals("TERCA-FEIRA", disponibilidade.dia_semana);
    }
}